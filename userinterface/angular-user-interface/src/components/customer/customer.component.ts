...
//   }
  ...
  async deleteRowData(data: any, index: any) {
    await this.modelOneArray.splice(index, 1)
    this.modelOneArray.forEach((element: { [x: string]: any; }, index: any) => {
      element["index"] = index;
    });
  }

  viewRowData(datas: any, index: any) {
    var tempData: any = {};
...
onDelete(modelOneArray: any,i: any){
