...
export class HttpServices {
  ...
  */
  ...
  public post(SUB_URL, params, headers?: any): Observable<any> {
    var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
  ...
  //  put with master url
  public put(SUB_URL, params, headers?: any): Observable<any> {
    var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  public patch(SUB_URL, params, headers?: any): Observable<any> {
    var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   get with mster url
  public get(SUB_URL, headers?: any): Observable<any> {
    var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  public delete(SUB_URL, headers?: any): Observable<any> {
    var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   get with admin url
  public getAdmin(_url, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   post with admin url
  public postAdmin(_url, params, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  // patch with master url
  public patchAdmin(_url, params, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   delete with master url
  public deleteAdmin(_url, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  public auth(_url, params, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //---------Common Call------------------------------//
   //   get with admin url
   public getCommon(_url, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   post with admin url
  public postCommon(_url, params, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  // patch with master url
  public patchCommon(_url, params, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
  ...
  //   delete with master url
  public deleteCommon(_url, headers?: any): Observable<any> {
    // var url = this.prepareHTTPConfig(SUB_URL);
    const httpOptions = {
      headers: new HttpHeaders(headers)
    };
