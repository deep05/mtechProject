...
getEncodedFilter(object:any=[], limit? ){
  return object
}

//COMMON FUNCTION TO POST EVENT DATA ON EVERY EVENT
  asyncCurrentEvent(event, menuId?:any, objectCode?:any) {
...
export class SecretKey {
  ...
  encryptUsingAES256(secret) {
    return secret;
  }
  decryptUsingAES256(secret) {
    return secret;
  }
